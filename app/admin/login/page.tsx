      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-xl">
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <div>
            ...
            <input aria-label="Email" type="email" autoComplete="username" className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none focus:border-brand-saffron focus:ring-2 focus:ring-brand-saffron/20" value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-700">Password</label>
            <input aria-label="Password" autoComplete="current-password" type="password" className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none focus:border-brand-saffron focus:ring-2 focus:ring-brand-saffron/20" value={password} onChange={(e) => setPassword(e.target.value)} />
          </div>
